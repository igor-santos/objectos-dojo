...
que a mesma extenda outras duas interfaces _Insertable_ e _HasId_
	...
	public interface Funcionario extends Insertable, HasId {
...
Siga para o próximo passo. Objetos falsos! <a href="{{ site.baseurl }}/procedimento/crud-entidade/00.2-criando-objetos-falsos.html" class="btn btn-success">Continuar!</a><br>
