...
Por fim, declaramos uma instâcia do DBUnit para podermos carregar o DefaultDataSet contendo o arquivo .xml contendo dados necessários de registros nas tabelas no banco de dados.
...
Seguir em frente? <a href="{{ site.baseurl }}/procedimento/crud-entidade/01.1-implementando_buscador_buscadores.html" class="btn btn-success">Buscadores!</a>
