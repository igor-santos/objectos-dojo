...
<table class="table table-bordered">
 <tr>
   ...
   <td>
	<a href="#0_0">Entendendo o problema do cliente</a>  
   </td>
 </tr>
 <tr>
   <td class="tac col2em">
   ...
   <td>
	<a href="#0_1">Quais campos devemos exibir?</a>  
   </td>
 </tr>
  <tr>
   <td class="tac col2em">
   ...
   <td>
    <a href="#0_2">Consultas específicas. Um caso especial</a>
   </td>
 </tr>
</table>

### <a id="0_0"> </a>Entendendo o problema do cliente 
...
Sabendo o problema do cliente, podemos começar a pensar quais campos desta tabela podemos exibir.

### <a id="0_1"> </a>Quais campos devemos exibir?   
...
### <a id="0_2"> </a>Consultas específicas. Um caso especial
...
Temos uma tabela `PESSOA_FISICA` com os seguintes campos:
...
E temos as tabelas `EMAIL`, `ENDERECO` e `TELEFONE`.<br>
Para realizar uma consulta do tipo "e-mails da pessoa física" precisariamos primeiro __buscar__ uma 
pessoa física. 

	PessoaFisica pessoaFisica = buscarPessoaFisica.porId(1);

Para saber mais sobre Buscadores leia o artigo [aqui]({{ site.baseurl }}/procedimento/crud-entidade/01.0-implementando_buscador_testes.html).
	
Com a pessoa física correta (João por exemplo), podemos listar os seus e-mails.

- joao.joao@google.com
- joao.joao@uol.com.br
- joao.joao@ig.com.br 

Veremos mais adiante como realizar as consultas (consulta geral do Livro).
...
Utilize o `Ctrl + 1` nesta linha para que o `Eclipse` crie a interface no diretório `/src/main/java/`. 	
...
Mais uma vez `Ctrl + 1` em `consulta.list(wrapper);` e crie a classe no diretório `/src/main/java/`.	
