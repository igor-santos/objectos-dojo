...
<table class="table table-bordered">
 <tr>
   ...
   <td>
	<a href="#0_0">Entendendo a especificação</a>  
   </td>
 </tr>
 <tr>
   <td class="tac col2em">
...
### <a id="0_0"> </a>Entendendo a especificação 
...
e não uma consulta geral. Isto é, quando há dependências de outras tabelas. Vejamos:
...
Para realizar uma consulta como "e-mails da pessoa física" precisariamos primeiro "Buscar" uma pessoa 
física com os [Buscadores]({{ site.baseurl }}/procedimento/crud-entidade/01.0-implementando_buscador_testes.html).

	PessoaFisica pessoaFisica = buscarPessoaFisica.porId(1);
	
Com a pessoa física correta, podemos listar os seus e-mails. Veremos mais adiante como realizar as consultas
(consulta geral do Livro).
